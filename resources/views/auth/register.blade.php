    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form method="POST" class="login100-form validate-form" action="{{ route('register.submit') }}">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Valid username is required">
                        <input type="text" class="input100" required placeholder="Your username" id="username"
                            name="username">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Password is required">
                        <input type="password" class="input100" required placeholder="Your Password" id="password"
                            name="password">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Comfirm password is required">
                        <input type="password" class="input100" required placeholder="Your confirm_password"
